"""psy-vtk psyplot plugin

This module defines the rcParams for the psy-vtk plugin. This module will
...
.. warning::
    ...
    .. code-block:: python
        ...
        import psyplot
        import psy_vtk.plugin"""
from psyplot.config.rcsetup import RcParams
from psy_vtk import __version__ as plugin_version


def get_versions(requirements=True):
    """Get the versions of psy-vtk and it's requirements
...
defaultParams = {
    ...
    'project.plotters': [
        {'plot_method_identifer': {
         ...
         }, dict, "The plot methods in the psy-vtk package"],
    # if you define new plotters, we recommend to assign a specific rcParams
    # key for it, e.g.
    # 'plotter.psy_vtk.my_fmt': [1, int, ' the value for my_fmt']
    }
